...
# Each user is identified by their unique user_id, and their conversation is saved as a list of messages, following OpenAI’s expected structure:
# _conversations[user_id] = [
#     {"role": "system", "content": "You are Luna, a smart home assistant..."},
#     {"role": "user", "content": "Turn off the kitchen light"},
#     {"role": "assistant", "content": "✅ Kitchen light turned off."}
# ]
# The role field indicates who sent the message:

# system: Defines Luna’s personality and abilities
